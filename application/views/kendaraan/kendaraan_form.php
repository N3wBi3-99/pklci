         ...
         <div class="box-body">
            <form action="<?php echo $action; ?>" method="post">
               <div class="form-horizontal">
                  <div class="box-body">
                     <a href="<?= base_url('kendaraan/import_excel') ?>" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i> Import Ms Excel</a>
                     ...
                     <div class="form-group">
                        <label for="int" class="col-sm-4 control-label">Nomor Plat </label>
                        <div class="col-sm-5">
                     ...
                     <div class="form-group">
                        <label for="int" class="col-sm-4 control-label">Nomor Rangka </label>
                        <div class="col-sm-5">
                     ...
                     <div class="form-group">
                        <label for="int" class="col-sm-4 control-label">Nomor Mesin </label>
                        <div class="col-sm-5">
                     ...
                     <div class="form-group">
                        <label for="int" class="col-sm-4 control-label">Nomor BPKB </label>
                        <div class="col-sm-5">
